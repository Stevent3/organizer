...
- [x] Steven-Feedback 11.09. („zu voll"): Kennzahlen als Chips in die Jetzt-dran-Karte (eigene Zeile weg), Geburtstage eine Zeile mit Personenwahl im Sheet, mehr Abstand zwischen den Blöcken; beta.22
- [ ] Weitere Entlastung offen: Schnell-Eingabe als Plus im Kopf, leere Kacheln ausblenden – Stevens Entscheidung
...
- [x] Groq-Fix 11.09.: gpt-oss ist ein Reasoning-Modell, Denk-Tokens zählen zu max_tokens → leere Antworten (Glückwunsch) und abgeschnittenes JSON („Failed to validate JSON" beim Tagesplan). App: +1500 Token Budget, `reasoning_effort: low`, JSON-Modus-Fehler → Wiederholung ohne Modus; Worker: Tipps/Briefing 1200/1000 Token statt 160/120 (waren dadurch praktisch tot)
